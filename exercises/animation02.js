...
//Pontas 1 e 2
var cilindroGeometria = new THREE.CylinderGeometry(0.07,0.07,1.0, 25);
var cilindroMaterial = new THREE.MeshBasicMaterial({color:'rgb(255,255,0)'});
var cilindro1= new THREE.Mesh(cilindroGeometria,cilindroMaterial);
var cilindro2= new THREE.Mesh(cilindroGeometria,cilindroMaterial);
cylinder2.add(cilindro1);
cylinder2.add(cilindro2);
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cilindro1.matrix.multiply(mat4.makeTranslation(0.0,2.0,0.0));
    cilindro2.matrix.multiply(mat4.makeTranslation(0.0,2.0,0));
  }
}
